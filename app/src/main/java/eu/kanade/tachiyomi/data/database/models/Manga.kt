...
interface Manga : SManga {
    ...
    var readingModeType: Int
        get() = viewer_flags and READING_MODE_TYPE_MASK
        set(readingMode) = setViewerFlags(readingMode, READING_MODE_TYPE_MASK)

    var orientationType: Int
        get() = viewer_flags and ORIENTATION_TYPE_MASK
        set(rotationType) = setViewerFlags(rotationType, ORIENTATION_TYPE_MASK)

    companion object {
        const val READING_MODE_TYPE_MASK = 0x00000007
        const val ORIENTATION_TYPE_MASK = 0x00000038
